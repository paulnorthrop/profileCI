...
To obtain smooth version of this plot, we call `profileCI()` with the default values: `mult = 2` and `faster = FALSE`, but this is much slower calculation. 
